...
const CreateLoad = ({navigation}) => {
  ...
  const [docknumber, setdocknumber] = useState('Dock Number')
    ...
    console.log("working1");
         ...
         Geolocation.getCurrentPosition(
          (position) => {
            ...
            Geocoder.from(32.524654,-83.600664)
            .then(json => {
...
console.log( `Precise Distance\n\n${pdis} Meter\nOR\n${pdis / 1000} KM`
  ...
  useEffect(()=>{
    ...
    Geocoder.init("AIzaSyDCRFvmRovo6gMuJ2hgVkQvp1VY35XnJLY")
 ...
 <DatePicker
      ...
      />
        ...
        <View style={styles.headview}>
          ...
          <Text style={{color:"white",fontSize:16,fontWeight:'600', alignSelf:'center'}}>Create a Load</Text>
          <View>
            </View>
        </View>
  ...
  <MapViewDirections
    origin={{latitude:platitude.length>0?platitude:currentloclat, longitude:plongitude.length>0?plongitude:currentloclon}}
    destination={{latitude:dlatitude.length>0?dlatitude:currentloclat, longitude:dlongitude.length>0?dlongitude:currentloclon}}
    apikey={GOOGLE_MAPS_APIKEY}
    strokeWidth={platitude.length>1 && dlongitude.length>1? 3:0}
...
/> */}
     ...
     contentContainerStyle={{height:'30%',paddingVertical:0,marginVertical:0, backgroundColor:'red', width:deviceWidth, }}
     horizontal={true}>
       ...
       style={{backgroundColor:vehicletype == '1' ?AppColors.Appcolor:"white",marginRight:5,marginVertical:'1%',borderColor:AppColors.Appcolor,borderWidth:0.6, borderRadius:10,justifyContent:'center', paddingHorizontal:'3%'}}>
         <Text style={{color:vehicletype== "1"? "white":'grey'}}>Dry Van</Text>
       </TouchableOpacity>
       ...
       <View style={{height:'80%',paddingHorizontal:'1%'}}>
